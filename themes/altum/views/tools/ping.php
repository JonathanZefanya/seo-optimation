                            ...
                            <div class="col-12 col-lg-6">
                                <div class="text-truncate my-2">
                                    <a href="<?= url('tools/' . \Altum\Router::$method . '?submit=1' . \Altum\Csrf::get_url_query() . '&' . http_build_query((array) $value)) ?>">
                                        <img referrerpolicy="no-referrer" src="<?= get_favicon_url_from_domain(parse_url($value->target, PHP_URL_HOST)) ?>" class="img-fluid icon-favicon mr-1" loading="lazy" />

                                        <?= remove_url_protocol_from_url($value->target) ?>
                                    </a>
                                </div>
                            </div>
                        <?php endforeach ?>
