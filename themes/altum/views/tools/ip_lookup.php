                            ...
                            <div class="col-12 col-lg-6">
                                <div class="text-truncate my-2">
                                    <a href="<?= url('tools/' . \Altum\Router::$method . '?submit=1' . \Altum\Csrf::get_url_query() . '&' . http_build_query((array) $value)) ?>">
                                        <img src="<?= ASSETS_FULL_URL . 'images/countries/' . mb_strtolower($value->country_code ?? 'unknown') . '.svg' ?>" class="img-fluid icon-favicon mr-1" data-toggle="tooltip" title="<?= get_country_from_country_code($value->country_code  ?? l('global.unknown')) ?>" loading="lazy" />
