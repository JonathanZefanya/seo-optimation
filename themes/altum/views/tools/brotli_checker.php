...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('tools.brotli_checker.name') ?></li>
            </ol>
        </nav>
    <?php endif ?>
    ...
    <div class="row mb-4">
        <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0 text-truncate">
            <h1 class="h4 m-0 text-truncate"><?= l('tools.brotli_checker.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.brotli_checker.description') ?>">
        ...
        <div class="mt-4">
            <?php if($data->result): ?>
                <div class="alert alert-success">
                    ...
                    <?= l('tools.brotli_checker.success_message.enabled') ?>
                </div>
            <?php else: ?>
                <div class="alert alert-warning">
                    <i class="fas fa-fw fa-times-circle text-warning mr-2"></i>
                    <?= l('tools.brotli_checker.success_message.disabled') ?>
                </div>
            <?php endif ?>
        </div>
    <?php endif ?>
