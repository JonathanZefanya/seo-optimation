...
<nav class="navbar navbar-main navbar-expand-lg navbar-light border border-gray-100 mt-4 rounded-2x <?= \Altum\Router::$controller_key == 'index' ? null : 'mb-6' ?>">
    <div class="container">
        <a
                href="<?= url() ?>"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="pr-lg-3">
                                    ...
                                    <a href="<?= url('audits') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-bolt mr-2"></i> <?= l('audits.menu') ?></a>

                                    <a href="<?= url('archived-audits') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-archive mr-2"></i> <?= l('archived_audits.menu') ?></a>
                                    ...
                                    <?php if(settings()->tools->is_enabled && (settings()->tools->access == 'everyone' || (settings()->tools->access == 'users' && is_logged_in()))): ?>
                                        <a href="<?= url('tools') ?>" class="dropdown-item"><i class="fas fa-fw fa-sm fa-tools mr-2"></i> <?= l('tools.menu') ?></a>
                                    <?php endif ?>
                                </div>
