...
<div class="app-sidebar">
    ...
    <div class="overflow-auto flex-grow-1">
        <ul class="app-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['Audits', 'Audit', 'AuditUpdate']) ? 'active' : null ?> d-flex">
                <a href="<?= url('audits') ?>"><i class="fa fa-fw fa-sm fa-bolt mr-2"></i> <?= l('audits.menu') ?></a>

                <a href="<?= url('archived-audits') ?>" class="<?= in_array(\Altum\Router::$controller, ['ArchivedAudits', 'ArchivedAudit']) ? 'bg-primary text-white' : null ?> default w-auto ml-1" data-tooltip data-tooltip-hide-on-click title="<?= l('archived_audits.menu') ?>">
                    <i class="fas fa-fw fa-sm fa-archive"></i>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['Websites', 'Website', 'WebsiteUpdate']) ? 'active' : null ?>">
