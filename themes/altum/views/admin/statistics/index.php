        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <a class="nav-link <?= $data->type == 'audits' ? 'active' : null ?>" href="<?= url('admin/statistics/audits?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-bolt mr-1"></i> <?= l('admin_audits.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'archived_audits' ? 'active' : null ?>" href="<?= url('admin/statistics/archived_audits?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-archive mr-1"></i> <?= l('admin_archived_audits.menu') ?></a>
                    <a class="nav-link <?= $data->type == 'tools' ? 'active' : null ?>" href="<?= url('admin/statistics/tools?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fas fa-fw fa-sm fa-screwdriver-wrench mr-1"></i> <?= l('admin_statistics.tools.menu') ?></a>
