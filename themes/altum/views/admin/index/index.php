            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/websites') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->websites) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->websites_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_audits.menu') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-bolt text-primary"></i>
                    </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/audits') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->audits) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->audits_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_archived_audits.menu') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-archive text-primary"></i>
                    </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/archived-audits') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->archived_audits) ?></span>
                    </a>
                    <div class="mt-1"><span class="small text-muted"><?= nr($data->archived_audits_current_month) ?> <?= mb_strtolower(l('global.date.this_month')) ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools.total_views') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-screwdriver-wrench text-primary"></i>
                    </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->total_views) ?></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.tools.total_submissions') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/statistics/tools') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->tools->total_submissions) ?></span>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/users') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->users) ?></span>
                    </a>
            ...
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= in_array(settings()->license->type, ['Extended License', 'extended']) ? url('admin/payments') : url('admin/settings/payment') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->payments) ?></span>
                    </a>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                ...
                <div class="mt-2 text-break">
                    <a href="<?= in_array(settings()->license->type, ['Extended License', 'extended']) ? url('admin/payments') : url('admin/settings/payment') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4"><?= nr($data->payments_total_amount, 2) ?></span> <small><?= settings()->payment->default_currency ?></small>
                    </a>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= sprintf(l('admin_users.last_activity'), ($row->last_activity ? \Altum\Date::get($row->last_activity, 1) : '<br />-')) ?>">
