    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-4">
        <div class="d-xl-none">
            <select name="settings_menu" class="custom-select">
                ...
                <option value="<?= url('admin/settings/audits') ?>" class="nav-link" <?= $data->method == 'audits' ? 'selected="selected"' : null ?>><?= l('admin_settings.audits.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'audits' ? 'active' : null ?>" href="<?= url('admin/settings/audits') ?>"><i class="fas fa-fw fa-sm fa-bolt mr-2"></i> <?= l('admin_settings.audits.tab') ?></a>
                    ...
                    <a class="nav-link <?= $data->method == 'pwa' ? 'active' : null ?>" href="<?= url('admin/settings/pwa') ?>"><i class="fas fa-fw fa-sm fa-rocket mr-2"></i> <?= l('admin_settings.pwa.tab') ?></a>
