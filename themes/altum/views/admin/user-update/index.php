        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="websites_limit" name="websites_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->websites_limit ?>" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="audits_per_month_limit" name="audits_per_month_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->audits_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="audits_bulk_limit"><?= l('admin_plans.plan.audits_bulk_limit') ?></label>
                    <input type="number" id="audits_bulk_limit" name="audits_bulk_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->audits_bulk_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="audits_retention" name="audits_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->audits_retention ?>" />
                ...
                <div class="form-group">
                    ...
                    <select id="audits_check_intervals" name="audits_check_intervals[]" class="custom-select" multiple="multiple">
                        <?php foreach($data->audits_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->user->plan_settings->audits_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                    ...
                    <?php foreach(require APP_PATH . 'includes/available_audit_tests.php' as $key => $value): ?>
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="audits_enabled_tests_<?= $key ?>" name="audits_enabled_tests[]" value="<?= $key ?>" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->audits_enabled_tests->{$key} ? 'checked="checked"' : null ?>>
