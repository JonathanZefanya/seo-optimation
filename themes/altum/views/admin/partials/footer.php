...
<footer class="d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0">
        ...
        <div>Powered by <img src="https://w7.pngwing.com/pngs/616/551/png-transparent-christmas-anime-desktop-shakugan-no-shana-4k-resolution-anime-manga-computer-wallpaper-fictional-character-thumbnail.png" class="icon-favicon" alt="Anime logo" /> <a href="https://xead.my.id/" target="_blank">Jonathan Zefanya</a>.</div>
    </div>
