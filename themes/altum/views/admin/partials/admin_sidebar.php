...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= in_array(\Altum\Router::$controller, ['AdminAudits']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/audits') ?>">
                    <i class="fas fa-fw fa-sm fa-bolt mr-2"></i> <?= l('admin_audits.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminArchivedAudits']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/archived-audits') ?>">
                    <i class="fas fa-fw fa-sm fa-archive mr-2"></i> <?= l('admin_archived_audits.menu') ?>
                </a>
            </li>

            <li class="<?= in_array(\Altum\Router::$controller, ['AdminWebsites']) ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/websites') ?>">
                    <i class="fas fa-fw fa-sm fa-pager mr-2"></i> <?= l('admin_websites.menu') ?>
                </a>
            </li>
