                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="custom-select custom-select-sm">
                                <option value="host" <?= $data->filters->search_by == 'host' ? 'selected="selected"' : null ?>><?= l('admin_domains.host') ?></option>
                            </select>
                        </div>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?= url('admin/audits?domain_id=' . $row->domain_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_audits.menu') ?>">
                                <i class="fas fa-fw fa-bolt text-muted"></i>
                            </a>

                            <a href="<?= url('admin/archived-audits?domain_id=' . $row->domain_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_archived_audits.menu') ?>">
