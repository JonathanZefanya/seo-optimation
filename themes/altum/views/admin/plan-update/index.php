        ...
        <form action="" method="post" role="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="websites_limit" name="websites_limit" min="-1" class="form-control" value="<?= $data->plan->settings->websites_limit ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> required="required"  />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="audits_per_month_limit" name="audits_per_month_limit" min="-1" class="form-control" value="<?= $data->plan->settings->audits_per_month_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="audits_bulk_limit"><?= l('admin_plans.plan.audits_bulk_limit') ?></label>
                    <input type="number" id="audits_bulk_limit" name="audits_bulk_limit" min="-1" class="form-control" value="<?= $data->plan->settings->audits_bulk_limit ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="audits_retention"><?= l('admin_plans.plan.audits_retention') ?></small></label>
                    <div class="input-group">
                        <input type="number" id="audits_retention" name="audits_retention" min="-1" class="form-control" value="<?= $data->plan->settings->audits_retention ?>" />
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <select id="audits_check_intervals" name="audits_check_intervals[]" class="custom-select" multiple="multiple" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                        <?php foreach($data->audits_check_intervals as $key => $value): ?>
                            <option value="<?= $key ?>" <?= in_array($key, $data->plan->settings->audits_check_intervals ?? [])  ? 'selected="selected"' : null ?>>
                                <?= $value ?>
                            </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="removable_branding_is_enabled" name="removable_branding_is_enabled" type="checkbox" class="custom-control-input" <?= $data->plan->settings->removable_branding_is_enabled ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                ...
                <div class="form-group custom-control custom-checkbox">
                    <input id="export_csv" name="export[]" value="csv" type="checkbox" class="custom-control-input" <?= $data->plan->settings->export->csv ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    <label class="custom-control-label" for="export_csv"><?= sprintf(l('global.export_to'), 'CSV') ?></label>
                </div>

                <div class="form-group custom-control custom-checkbox">
                    <input id="export_json" name="export[]" value="json" type="checkbox" class="custom-control-input" <?= $data->plan->settings->export->json ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    <label class="custom-control-label" for="export_json"><?= sprintf(l('global.export_to'), 'JSON') ?></label>
                </div>

                <div class="form-group custom-control custom-checkbox">
                    <input id="export_pdf" name="export[]" value="pdf" type="checkbox" class="custom-control-input" <?= $data->plan->settings->export->pdf ? 'checked="checked"' : null ?> <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?>>
                    ...
                    <?php foreach(require APP_PATH . 'includes/available_audit_tests.php' as $key => $value): ?>
                        <div class="col-6 mb-3">
                            <div class="custom-control custom-checkbox">
                                <input id="audits_enabled_tests_<?= $key ?>" name="audits_enabled_tests[]" value="<?= $key ?>" type="checkbox" class="custom-control-input" <?= $data->plan->settings->audits_enabled_tests->{$key} ? 'checked="checked"' : null ?>>
