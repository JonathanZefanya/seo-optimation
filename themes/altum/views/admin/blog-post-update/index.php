    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" class="form-control d-none" style="height: 15rem;"><?= e($data->blog_post->content) ?></textarea>
            </div>
            ...
            <div class="form-group custom-control custom-switch">
                ...
                <label class="custom-control-label" for="is_published"><i class="fas fa-fw fa-sm fa-dot-circle text-muted mr-1"></i> <?= l('admin_blog.is_published') ?></label>
            </div>
