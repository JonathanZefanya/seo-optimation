...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex d-print-none">
            <div class="">
                <div class="dropdown">
                    <button type="button" class="btn btn-light dropdown-toggle-simple <?= count($data->websites) ? null : 'disabled' ?>" data-toggle="dropdown" data-boundary="viewport" data-tooltip title="<?= l('global.export') ?>" data-tooltip-hide-on-click>
    ...
    <?php if(count($data->websites) && $data->websites_stats['total_tests']): ?>
        <div class="card mb-3">
            <div class="card-body">
                <?php
                $major_issues_percentage = number_format($data->websites_stats['major_issues'] * 100 / $data->websites_stats['total_tests'], '2', '.', '');
                $moderate_issues_percentage = number_format($data->websites_stats['moderate_issues'] * 100 / $data->websites_stats['total_tests'], '2', '.', '');
                $minor_issues_percentage = number_format($data->websites_stats['minor_issues'] * 100 / $data->websites_stats['total_tests'], '2', '.', '');
                $passed_tests_percentage = number_format($data->websites_stats['passed_tests'] * 100 / $data->websites_stats['total_tests'], '2', '.', '');
