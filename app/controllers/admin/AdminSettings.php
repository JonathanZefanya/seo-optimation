...
class AdminSettings extends Controller {
    ...
    public function tools() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'last_submissions_is_enabled' => isset($_POST['last_submissions_is_enabled']),
    ...
    public function audits() {
        ...
        if(!empty($_POST)) {
            ...
            /* :) */
            $_POST['accept_encoding'] = input_clean($_POST['accept_encoding']);
            $_POST['user_agent'] = input_clean($_POST['user_agent']);
            $_POST['request_timeout'] = input_clean($_POST['request_timeout']);
            ...
            foreach(require APP_PATH . 'includes/available_audit_tests.php' as $key => $value) {
                $available_tests[$key] = in_array($key, $_POST['available_tests'] ?? []);
            }

            $value = json_encode([
                'accept_encoding' => $_POST['accept_encoding'],
                'user_agent' => $_POST['user_agent'],
                'request_timeout' => $_POST['request_timeout'],
                'double_check_is_enabled' => isset($_POST['double_check_is_enabled']),
                'double_check_wait' => (int) $_POST['double_check_wait'],
            ...
            $this->update_settings('audits', $value);
        }
    }
