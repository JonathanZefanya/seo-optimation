...
return [
    ...
    'admin_blog.editor_raw' => 'No editor',
    'admin_blog.editor_wysiwyg' => 'WYSIWYG',
    'admin_blog.editor_blocks' => 'Blocks',
    'admin_blog.editor_confirm' => 'By switching the editor, you may lose your already existing content.',
    ...
    'admin_resources.editor_confirm' => 'By switching the editor, you may lose your already existing content.',
    ...
    'admin_plans.plan.notification_handlers_limit' => 'Notification handlers',
    'admin_plans.plan.active_notification_handlers_per_resource_limit' => 'Active notification handlers per resource',
    'admin_plans.plan.per_month' => 'per month',
    'admin_plans.plan.websites_limit' => 'Websites limit',
    'admin_plans.plan.audits_per_month_limit' => 'Audits limit',
    'admin_plans.plan.audits_bulk_limit' => 'Audits bulk limit',
    'admin_plans.plan.audits_retention' => 'Audits retention',
    'admin_plans.plan.audits_retention_help' => 'How many days will the audit be kept.',
    'admin_plans.plan.audits_check_intervals' => 'Audits check intervals',
    'admin_plans.plan.audits_check_intervals_help' => 'Select no interval if you want to disable access to this feature.',
    ...
    'admin_plans.plan.removable_branding_is_enabled_help' => 'This gives the option for people to remove branding from the branded resources.',
    'admin_plans.plan.password_protection_is_enabled' => 'Password protection',
    'admin_plans.plan.password_protection_is_enabled_help' => 'Enable access to set a password protection for audits.',
    ...
    'admin_plans.plan.audits_enabled_tests' => 'Enabled audit tests',
    ...
    'admin_codes.days_help' => 'How many days will the plan be available for.',
    ...
    'admin_index.tools.total_views' => 'Tools views',
    'admin_index.tools.total_submissions' => 'Tools submissions',
    ...
    'admin_users.referred_by' => 'Referred by',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66audit-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.users.login_rememberme_checkbox_is_checked' => '"Remember me" checked on login page by default',
    ...
    'admin_settings.payment.user_plan_expiry_checker_is_enabled' => 'User plan expiry checker',
    'admin_settings.payment.user_plan_expiry_checker_is_enabled_help' => 'Automatically check and expire plans via the Cron job for users who stop paying their plans. If disabled, an expired plan will be reset when the user will log into his account.',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.smtp.reply_to_help' => 'The email that is used for the receiver to replying.',
    ...
    'admin_settings.theme.primary_help' => 'You can check and choose from already created shadings, from <a href="https://tailwindcss.com/docs/customizing-colors" target="_blank">Tailwind Color Palettes</a>.',
    'admin_settings.theme.gray' => 'Gray color shades - from light to dark',
    'admin_settings.theme.gray_help' => 'You can check and choose from already created shadings, from <a href="https://tailwindcss.com/docs/customizing-colors" target="_blank">Tailwind Color Palettes</a>. Choose a gray color palette.',
    ...
    'admin_settings.pwa.display_install_bar' => 'Display install helper bar in the footer for your users',
    ...
    'admin_settings.cron.audits' => 'Audits refresh cron job',
    ...
    'admin_settings.audits.tab' => 'Audits',
    'admin_settings.audits.domains' => 'Domains',
    'admin_settings.audits.requests' => 'Requests',
    'admin_settings.audits.audits' => 'Audits',
    'admin_settings.audits.example_url' => 'Example public audit URL',
    'admin_settings.audits.example_url_help' => 'Display example audit page button on the homepage. Leave empty to disable.',
    'admin_settings.audits.accept_encoding' => 'Available encodings',
    'admin_settings.audits.accept_encoding_help' => 'Modify this value based on what your server supports. Comma separated values. Available values: br, gzip, deflate, zstd, compress, identity.',
    'admin_settings.audits.user_agent' => 'Custom user agent',
    'admin_settings.audits.user_agent_help' => 'The user agent that is used when audit requests are sent. Leave empty for default.',
    'admin_settings.audits.request_timeout' => 'Request timeout',
    'admin_settings.audits.request_timeout_help' => 'The amount of time to wait for a response when audit requests are sent.',
    'admin_settings.audits.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.audits.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.audits.domains_custom_main_ip' => 'IP of your server',
    'admin_settings.audits.domains_custom_main_ip_help' => 'The IP that will be displayed when adding a custom domain. Leave empty to show the default detected server IP.',
    'admin_settings.audits.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.audits.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    'admin_settings.audits.double_check_is_enabled' => 'Double check a failed audit refresh',
    'admin_settings.audits.double_check_is_enabled_help' => 'When a refresh of an audit fails when checked via the cron: the system waits X seconds and sends another request try and check it.',
    'admin_settings.audits.double_check_wait' => 'Double check wait time',
    'admin_settings.audits.double_check_wait_help' => 'How much to wait before sending another request to a failed audit refresh. Only applies when the above toggle is enabled.',
    'admin_settings.audits.available_tests' => 'Available tests',

    'admin_settings.notification_handlers.tab' => 'Notification handlers',
    ...
    'admin_settings.notification_handlers.twilio_number' => 'Twilio phone number',
    ...
    'admin_settings.tools.extra_content_is_enabled' => 'Enable extra text content block',
    'admin_settings.tools.share_is_enabled' => 'Enable share buttons',
    'admin_settings.tools.similar_widget_is_enabled' => 'Enable similar tools widget',
    'admin_settings.tools.popular_widget_is_enabled' => 'Enable popular tools widget',
    'admin_settings.tools.available_tools' => 'Available tools',
    'admin_settings.tools.views_is_enabled' => 'Enable views count to be displayed',
    'admin_settings.tools.submissions_is_enabled' => 'Enable submissions count to be displayed',
    'admin_settings.tools.last_submissions_is_enabled' => 'Enable last submissions widget',
    ...
    'admin_languages.auto_translate_all' => 'Auto translate',
    ...
    'admin_languages.auto_translate' => 'Auto translate',
    ...
    'admin_statistics.tools.menu' => 'Tools statistics',
    'admin_statistics.tools.header' => 'Tools statistics',
    'admin_statistics.tools.tool' => 'Tool',
    'admin_statistics.tools.total_views' => 'Views',
    'admin_statistics.tools.total_submissions' => 'Submissions',
    ...
    'admin_domains.helper' => 'Make sure that your domain or subdomain has an A record pointing to %s or CNAME record pointing to %s.',
    ...
    'admin_domains.dns' => 'DNS Values',
    'admin_domains.dns_help' => 'These are the DNS values detected at this moment in time.',
    ...
    'admin_websites.title' => 'Websites',
    'admin_websites.header' => 'Websites',
    'admin_websites.menu' => 'Websites',


    'admin_audits.title' => 'Audits',
    'admin_audits.header' => 'Audits',
    'admin_audits.menu' => 'Audits',

    'admin_archived_audits.title' => 'Archived audits',
    'admin_archived_audits.header' => 'Archived audits',
    'admin_archived_audits.menu' => 'Archived audits',
];
